...
Styling
Hand-written CSS with design tokens (custom properties) — no framework
...
Content
Static JSON, fetched client-side
...
Typefaces:Host Grotesk (primary, Latin) · IBM Plex Sans Arabic (Arabic) · IBM Plex Mono (stats, timeline numbers — a small "ledger" accent fitting an economics/fintech club).
...
Team Lead
Rahal Akram El Mokhtar



📬 Contact

• Instagram: @econovo.club
• Facebook: Econovo Club
